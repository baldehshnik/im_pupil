...
import com.sparkfusion.services.admin.magazine.viewmodel.HistoryDateViewModel
            ...
            is HistoryDateViewModel.ReadingState.Success -> {
                ...
                Column(
                    ...
                    Button(
                        ...
                        onClick = {
                            onSearchClick(state.groupMemberId, dateState.selectedDateMillis ?: System.currentTimeMillis())
                        }
                    ) {
                        SFProRoundedText(
